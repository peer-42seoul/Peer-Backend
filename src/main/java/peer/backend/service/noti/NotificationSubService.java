...
//import peer.backend.entity.noti.OldNotificationTarget;
...
//    }
//
//    private List<OldNotificationTarget> makeNotificationTarget(List<User> target, Notification event){
//        List<OldNotificationTarget> result = target.isEmpty() ? Collections.emptyList() : new ArrayList<>();
//        if(!target.isEmpty()){
//            target.forEach(user -> {
//                OldNotificationTarget element = OldNotificationTarget.builder()
...
//    }
//
//    private List<OldNotificationTarget> makeTeamTargets(Notification event, List<Long> teamIds)
//            throws NullPointerException{
//        List<OldNotificationTarget> result = null;
//
...
//    }
//
//    private List<OldNotificationTarget> makeUserTargets(Notification event, List<Long> userIds)
//            throws NullPointerException{
//        List<OldNotificationTarget> result = null;
...
//        List<OldNotificationTarget> convertedTargets;
...
//        List<OldNotificationTarget> convertedTargets = null;
//
//        if (event.getTargetType().equals(TargetType.CERTAIN)) {
//            List<OldNotificationTarget> earlyTargets = event.getTargets();
