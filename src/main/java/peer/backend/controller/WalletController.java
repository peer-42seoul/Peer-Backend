...
import peer.backend.dto.wallet.UpdateWalletItemRequest;
...
public class WalletController {
    ...
    @PutMapping
    public void updateWalletItem(@RequestBody @Valid UpdateWalletItemRequest request) {
        this.walletService.updateWallet(request.getActionTypeCode(), request.getActionTypeName(),
            request.getWallet());
    }
}
