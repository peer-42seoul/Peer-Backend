...
//        assertThat(achievements.size()).isEqualTo(10);
        ...
        userAchievements.add(new UserAchievement(user1.getId(), achievements.get(3).getId(), user1,
            achievements.get(3), LocalDateTime.now()));
        userAchievements.add(new UserAchievement(user1.getId(), achievements.get(5).getId(), user1,
            achievements.get(5), LocalDateTime.now()));
        userAchievements.add(new UserAchievement(user1.getId(), achievements.get(8).getId(), user1,
            achievements.get(8), LocalDateTime.now()));
